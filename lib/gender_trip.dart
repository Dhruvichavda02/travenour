...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: GendertripScreen(),
    );
  }
}

class GendertripScreen extends StatefulWidget {
  const GendertripScreen({super.key});

  @override
  _GendertripScreen createState() => _GendertripScreen();
}

class _GendertripScreen extends State<GendertripScreen> {
