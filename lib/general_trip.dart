...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: GeneraltripScreen(),
    );
  }
}

class GeneraltripScreen extends StatefulWidget {
  const GeneraltripScreen({super.key});

  @override
  _GeneraltripScreen createState() => _GeneraltripScreen();
}

class _GeneraltripScreen extends State<GeneraltripScreen> {
